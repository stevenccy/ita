								...
								<div class="tab-content xt-pro-small-image">
									...
									<div role="tabpanel" id="xt-pro-1" class="tab-pane fade">
										<a class="grouped_elements" data-fancybox="gallery"
											href="assets/images/s-1.jpg"> <img
											src="assets/images/s-1.jpg" alt="" class="img-responsive">
										</a>
									</div>
									<div role="tabpanel" id="xt-pro-2" class="tab-pane fade">
										<a class="grouped_elements" data-fancybox="gallery"
											href="assets/images/s-2.jpg"> <img
											src="assets/images/s-2.jpg" alt="" class="img-responsive">
										</a>
									</div>
									<div role="tabpanel" id="xt-pro-3"
										class="tab-pane fade active in">
										<a class="grouped_elements" data-fancybox="gallery"
											href="assets/images/s-3.jpg"> <img
											src="assets/images/s-3.jpg" alt="" class="img-responsive">
										</a>
									</div>
									<div role="tabpanel" id="xt-pro-4" class="tab-pane fade">
										<a class="grouped_elements" data-fancybox="gallery"
											href="assets/images/s-4.jpg"> <img
											src="assets/images/s-4.jpg" alt="" class="img-responsive">
										</a>
									</div>
								</div>
								<!-- Nav tabs -->
								<ul id="tablist" class="xt-pro-thumbs-list" role="tablist">
									<li role="presentation" class=""><a href="#xt-pro-1"
										role="tab" data-toggle="tab" aria-expanded="false"> <img
											src="assets/images/s-1.jpg" alt="product thumbs">
									</a></li>
									<li role="presentation" class=""><a href="#xt-pro-2"
										role="tab" data-toggle="tab" aria-expanded="false"> <img
											src="assets/images/s-2.jpg" alt="product thumbs">
									</a></li>
									<li role="presentation" class="active"><a href="#xt-pro-3"
										role="tab" data-toggle="tab" aria-expanded="true"> <img
											src="assets/images/s-3.jpg" alt="product thumbs">
									</a></li>
									<li role="presentation" class=""><a href="#xt-pro-4"
										role="tab" data-toggle="tab" aria-expanded="false"> <img
											src="assets/images/s-4.jpg" alt="product thumbs">
									</a></li>
								</ul>
							</div>
						</div>
