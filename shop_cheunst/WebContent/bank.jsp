				...
				<div class="top_bar clear">
					...
					<div class="minicart">
						<a class="minicart_link" href="#"> <span class="item">
								<b>2</b> 件/
						</span> <span class="price"> <b>￥199.80</b>
						</span>
						</a>
					</div>
					<!-- 小购物车结束 -->
				...
				<div class="pay">
					<div class="pay-inner">
						...
						<div class="fl yibao-logo">
							<a href=""><img src="${shop}/images/yibao.jpg" width="110"
								height="35" alt="" /></a>
						</div>
							...
							<ul>
								<c:forEach items="${applicationScope.bankName}" var="name">
									...
									<li><input type="radio" name="pd_FrpId"
										value="${fn:substring(name,0,fn:indexOf(name, '.'))} " />&nbsp;
										<img src="${shop}/images/bank/${name}" /></li>
								</c:forEach>
							</ul>
						</div>
						<div class="clear"></div>
